...
// Function to sort processes based on burst time (ascending order)
void sortProcessesSJF(int n, int bt[], int pid[])
{
    for (int i = 0; i < n - 1; i++)
    {
...
void calculateTimesSJF(int n, int bt[], int wt[], int tat[])
{
...
void sjf(int n, int bt[], int priority[], int p[])
{
    ...
    sortProcessesSJF(n, bt, pid);

    // Calculate waiting time and turnaround time
    calculateTimesSJF(n, bt, wt, tat);
